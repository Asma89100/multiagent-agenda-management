...
(function(root) {
    ...
    _abt.createMaster = function(me, subject, values, invitee_list, mailbox, callback) {
        ...
        return new _abt.SharedAppointment(me, true, subject, values, invitee_list, constraints, mailbox, callback);
    };
    
    _abt.createSlave = function(me, subject, values, master, mailbox, callback) {
        var fun = function(v1, v2) {
            return v1 === v2;
        };
        ...
        return new _abt.SharedAppointment(me, false, subject, values, [], constraints, mailbox, callback);
    };
    
    _abt.SharedAppointment = function(me, is_host, subject, values, agents, constraints, mailbox, callback) {
	    this.me = me;
