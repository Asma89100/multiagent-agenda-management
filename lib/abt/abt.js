...
(function(root) {
    ...
    _abt.createMaster = function(owner, subject, values, invitee_list, mailbox, callback) {
        ...
        return new _abt.SharedAppointment(owner, true, subject, values, invitee_list, constraints, mailbox, callback);
    };
    
    _abt.createSlave = function(owner, subject, values, master, mailbox, callback) {
        var fun = function(v1, v2) {
            return v1 === v2;
        };
        ...
        return new _abt.SharedAppointment(owner, false, subject, values, [], constraints, mailbox, callback);
    };
    
    _abt.SharedAppointment = function(owner, is_host, subject, values, agents, constraints, mailbox, callback) {
	    this.owner = owner;
	...
	_abt.SharedAppointment.prototype.receive = function(msg) {    
	    if (msg.type === "ok?") {
	       ...
	       this.callback(this);
        } else if (msg.type === "ss" && this.is_host) {
	    ...
	    if(this.state == "PENDING" && (msg.type == "ok?" || msg.type == "nogood") && !this.is_host) {
	       this.mailbox.push({
                "from" : this.owner,
                "to" : msg.from,
                "subject" : this.subject,
