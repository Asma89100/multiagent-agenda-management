...
(function(root) {
    var _mam = function(name, mailbox, callback) {
        ...
        this.callback = (function(callback, that) {
            return function(o) {
	            if(o.state == "OK") {	                
	                var a = that.addAppointment(o.subject, o.current_value, o.current_value+1, o.host, o.invitees);
	                callback(o.state, a);
    ...
    _mam.prototype.createSharedAppointment = function(subject, start, end, duration, invitee_list) {
        var range = [];
        ...
        this.shared_appointment_list.push(abt.createMaster(this.name, subject, range, invitee_list, this.mailbox, this.callback));
    },
