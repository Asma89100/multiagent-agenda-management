...
describe('MAM', function() {
    ...
    describe('#createSharedAppointment()', function() {            
        it('should create an shared appointment correctly', function() {
            var mailbox = [];
            
            var m1 = new mam("test-1", mailbox);
            var m2 = new mam("test-2", mailbox);
        ...
        it('should also create this shared appointment correctly', function() {
            var mailbox = [];
            
            var m1 = new mam("test-1", mailbox);
            var m2 = new mam("test-2", mailbox);
            var m3 = new mam("test-3", mailbox);
