    ...
    describe('TP3C', function() {
        describe('#solve()', function() {
            it('should process this stp instance correctly', function() {
                ...
                var e2 = new Edge(n1, n3, -1, 1);
                var e3 = new Edge(n1, n4, -3, 3);
                
                var e4 = new Edge(n2, n3, -1, 1);
                var e5 = new Edge(n3, n4, -1, 1);
                
                var node_list = [ n1, n2, n3, n4 ];
                var edge_list = [ e1, e2, e3, e4, e5 ];
