...
describe('ABT', function() {
    ...
    describe('Scenario 1', function() {            
        it('should process this scenario correctly', function(done) {
		    ...
		    var a1_callback = function(a) {
                setTimeout(function(){
	                a1.state.should.equal("OK");
	                a2.state.should.equal("OK");
	                a3.state.should.equal("OK");
	                a4.state.should.equal("OK");
		    ...
		    var others_callback = function(a) {
		    };
